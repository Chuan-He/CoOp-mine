...
class domain_net(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        train_datasets, val_datasets, test_datasets, class_names = \
            converter_domainbed.get_domainbed_datasets(dataset_name="domain_net", root="datasets/domainbed/data", targets="painting", holdout=0.2)
